...
extern unsigned char _binary___color_burn_u8_gaudi2_o_start;
extern unsigned char _binary___color_burn_u8_gaudi2_o_end;

 gcapi::GlueCodeReturn_t ColorBurnU8Gaudi2::GetKernelName(
             char kernelName [gcapi::MAX_NODE_NAME])
 {
     strcpy(kernelName,"custom_color_burn_u8_gaudi2");
     return gcapi::GLUE_SUCCESS;
 }


gcapi::GlueCodeReturn_t ColorBurnU8Gaudi2::GetGcDefinitions(
            ...
            gcapi::HabanaKernelInstantiation_t* out_defs)
{
    ...
    **************************************************************************************/
    unsigned IsaSize = (&_binary___color_burn_u8_gaudi2_o_end - 
                        &_binary___color_burn_u8_gaudi2_o_start);
