...
extern unsigned char _binary___linear_dodge_u8_gaudi2_o_start;
extern unsigned char _binary___linear_dodge_u8_gaudi2_o_end;

 gcapi::GlueCodeReturn_t LinearDodgeU8Gaudi2::GetKernelName(
             char kernelName [gcapi::MAX_NODE_NAME])
 {
     strcpy(kernelName,"custom_linear_dodge_u8_gaudi2");
     return gcapi::GLUE_SUCCESS;
 }


gcapi::GlueCodeReturn_t LinearDodgeU8Gaudi2::GetGcDefinitions(
            ...
            gcapi::HabanaKernelInstantiation_t* out_defs)
{
    ...
    **************************************************************************************/
    // We operate on 2D index space for LinearDodge because input tensors and output tensors
    // are 2D.
    ...
    **************************************************************************************/
    unsigned IsaSize = (&_binary___linear_dodge_u8_gaudi2_o_end - 
                        &_binary___linear_dodge_u8_gaudi2_o_start);
