...
extern unsigned char _binary___llama_rmsnorm_part2_f32_gaudi2_o_start;
extern unsigned char _binary___llama_rmsnorm_part2_f32_gaudi2_o_end;

 gcapi::GlueCodeReturn_t LlamaRmsnormPart2F32Gaudi2::GetKernelName(
             char kernelName [gcapi::MAX_NODE_NAME])
 {
     strcpy(kernelName,"custom_llama_rmsnorm_part2_f32_gaudi2");
     return gcapi::GLUE_SUCCESS;
 }


gcapi::GlueCodeReturn_t LlamaRmsnormPart2F32Gaudi2::GetGcDefinitions(
            gcapi::HabanaKernelParams_t* in_defs,
            gcapi::HabanaKernelInstantiation_t* out_defs)
{
    gcapi::GlueCodeReturn_t retVal;
    LlamaRmsnormPart2Param* param_def = static_cast<LlamaRmsnormPart2Param*>(in_defs->NodeParams);
    ...
    **************************************************************************************/
    unsigned IsaSize = (&_binary___llama_rmsnorm_part2_f32_gaudi2_o_end - 
                        &_binary___llama_rmsnorm_part2_f32_gaudi2_o_start);
