...
extern unsigned char _binary___c2taco_elemwise_plus_scalar_mul_i32_gaudi2_o_start;
extern unsigned char _binary___c2taco_elemwise_plus_scalar_mul_i32_gaudi2_o_end;

 gcapi::GlueCodeReturn_t C2TacoElemwisePlusScalarMulI32Gaudi2::GetKernelName(
             char kernelName [gcapi::MAX_NODE_NAME])
 {
     strcpy(kernelName,"custom_c2taco_elemwise_plus_scalar_mul_i32_gaudi2");
     return gcapi::GLUE_SUCCESS;
 }


gcapi::GlueCodeReturn_t C2TacoElemwisePlusScalarMulI32Gaudi2::GetGcDefinitions(
            gcapi::HabanaKernelParams_t* in_defs,
            gcapi::HabanaKernelInstantiation_t* out_defs)
{
    gcapi::GlueCodeReturn_t retVal;
    Param* param_def = static_cast<Param*>(in_defs->NodeParams);
    ...
    **************************************************************************************/
	out_defs->kernel.paramsNr = sizeof(*param_def)/ sizeof(int);
    memcpy(&( out_defs->kernel.scalarParams[0]), param_def, sizeof(*param_def));

	/*************************************************************************************
    *    Stage V -  Load ISA into the descriptor.
    **************************************************************************************/
    unsigned IsaSize = (&_binary___c2taco_elemwise_plus_scalar_mul_i32_gaudi2_o_end - 
                        &_binary___c2taco_elemwise_plus_scalar_mul_i32_gaudi2_o_start);
