...
extern unsigned char _binary___llama_softmax_part4_f32_gaudi2_o_start;
extern unsigned char _binary___llama_softmax_part4_f32_gaudi2_o_end;

 gcapi::GlueCodeReturn_t LlamaSoftmaxPart4F32Gaudi2::GetKernelName(
             char kernelName [gcapi::MAX_NODE_NAME])
 {
     strcpy(kernelName,"custom_llama_softmax_part4_f32_gaudi2");
     return gcapi::GLUE_SUCCESS;
 }


gcapi::GlueCodeReturn_t LlamaSoftmaxPart4F32Gaudi2::GetGcDefinitions(
            gcapi::HabanaKernelParams_t* in_defs,
            gcapi::HabanaKernelInstantiation_t* out_defs)
{
    gcapi::GlueCodeReturn_t retVal;
    LlamaSoftmaxPart4Param* param_def = static_cast<LlamaSoftmaxPart4Param*>(in_defs->NodeParams);
    ...
    **************************************************************************************/
    unsigned IsaSize = (&_binary___llama_softmax_part4_f32_gaudi2_o_end - 
                        &_binary___llama_softmax_part4_f32_gaudi2_o_start);
