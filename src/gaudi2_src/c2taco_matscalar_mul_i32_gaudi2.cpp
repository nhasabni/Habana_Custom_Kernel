...
extern unsigned char _binary___c2taco_matscalar_mul_i32_gaudi2_o_start;
extern unsigned char _binary___c2taco_matscalar_mul_i32_gaudi2_o_end;

 gcapi::GlueCodeReturn_t C2TacoMatScalarMulI32Gaudi2::GetKernelName(
             char kernelName [gcapi::MAX_NODE_NAME])
 {
     strcpy(kernelName,"custom_c2taco_matscalar_mul_i32_gaudi2");
     return gcapi::GLUE_SUCCESS;
 }


gcapi::GlueCodeReturn_t C2TacoMatScalarMulI32Gaudi2::GetGcDefinitions(
            ...
            gcapi::HabanaKernelInstantiation_t* out_defs)
{
    ...
    **************************************************************************************/
    unsigned IsaSize = (&_binary___c2taco_matscalar_mul_i32_gaudi2_o_end - 
                        &_binary___c2taco_matscalar_mul_i32_gaudi2_o_start);
