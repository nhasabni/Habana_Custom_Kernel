...
void DarkenBlendF32Gaudi2Test::darkenblendf32_reference_implementation(
...
int DarkenBlendF32Gaudi2Test::runTest()
{
    ...
    darkenblendf32_reference_implementation(base, active, out_ref);
    ...
    strcpy(m_in_defs.nodeName, kernelNames[GAUDI2_KERNEL_DARKEN_BLEND_F32]);
